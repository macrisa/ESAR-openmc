...
class srp_to_omc(object):
    ...
    #   "surf 1FT.1 sqc 0 0 3.482 0.932 % 1st tube outer cladding"
        ...
        def build(self):
            return openmc.model.RectangularPrism(width=self.r*2,height=self.r*2,origin=self.coords,corner_radius=self.corner_r)
    ...
    class cone(object):
        ...
        def build(self):
            if self.cone_type=='ckz':
                return openmc.model.ZConeOneSided(x0=self.coords[0],y0=self.coords[1],z0=self.coords[2],r2=self.r2,up=self.up)
            
            if self.cone_type=='cky':
                return openmc.model.YConeOneSided(x0=self.coords[0],y0=self.coords[1],z0=self.coords[2],r2=self.r2,up=self.up)
            
            if self.cone_type=='ckx':
                return openmc.model.XConeOneSided(x0=self.coords[0],y0=self.coords[1],z0=self.coords[2],r2=self.r2,up=self.up)
...
boundary_surface = openmc.model.RectangularPrism(width=9.5,height=9.5,origin=[0,0],corner_radius=1,boundary_type='reflective')
...
root_list =  [cell_088,cell_089,cell_0810,cell_0811,cell_0812,cell_0813,cell_0814,cell_0815,cell_0816,cell_0817,cell_0818,cell_0819,cell_0820,
              cell_0821,cell_0822,cell_0823,cell_0824,cell_0826,cell_0827,cell_0828,cell_0829,cell_0830,
              cell_0831,cell_0832,cell_0833,cell_0834,cell_0835,cell_0836,cell_0837,cell_0838,cell_0839,cell_0840,
              cell_0841,cell_0842,cell_0843,cell_0844,cell_0845,cell_0846,cell_0847,cell_0848,cell_0849,cell_0850,
              cell_0851,cell_0852,cell_0853,cell_0854,cell_0855,cell_0856,cell_0857,cell_0858,cell_0860,
              cell_0861,cell_0862,cell_0863,cell_0864,cell_0865,cell_0866,cell_0867,cell_0868,cell_0869,cell_0870,
              cell_0871,cell_0872,cell_0873,cell_0874,cell_0875,cell_0876]

root_universe = openmc.Universe(cells=root_list)
test_universe = openmc.Universe(cells=[cell_088,cell_089,cell_0810,cell_0811,cell_0812,cell_0813,cell_0814,cell_0815,cell_0816,cell_0817,cell_0818,cell_0819,cell_0820])
